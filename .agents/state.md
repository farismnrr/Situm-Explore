...
Plan 048 — Public Landing Page is active on `plan/048-public-landing-page`.

The plan replaces the stale prototype-era public home page with a current, capability-truthful Situm Explore landing page. Scope is limited to the web presentation surface; authenticated product behavior, backend APIs, Situm capability, and mobile code are unchanged.
